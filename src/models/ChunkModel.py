...
class ChunkModel(BaseDataModel):
    ...
    async def init_collection(self):
        ...
        if DataBaseEnums.COLLECTION_CHUNK_NAME.value  not in all_collections:
            self.collection = self.db_client[DataBaseEnums.COLLECTION_CHUNK_NAME.value] # pyright: ignore[reportIndexIssue]
    ...
    async def delete_project_by_projectid(self,project_id: ObjectId):
